...
public class ProductsPanel extends javax.swing.JPanel {
     ...
     * @param mainPanel
     */
    public ProductsPanel(JPanel mainPanel) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Name", "Weight", "Pieces / packing", "Sale price", "Stock", "Total Weight", "Status"
            }
        ) {
        ...
        jButton5.setText("Print Rate List");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Global.addPanel(AddProductPanel.class, mainPanel, jTable1.getSelectedRowCount());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ArrayList<Products> list = (ArrayList<Products>) Global.CONTROLLER.fetch("Products").getResponseObject();
        ReportController.createProductsEditReport(list,true);

    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ArrayList<Products> list = (ArrayList<Products>) Global.CONTROLLER.fetch("Products").getResponseObject();
        ReportController.createProductsEditReport(list,false);
    ...
    private void addDataToTable() {
        ...
        for (Products p : list) {
            dtm.addRow(new Object[]{
                p.getCode(),
                p.getName() + "-" + p.getFlavour(),
                Frmttr.Format(p.getWeight(), Frmttr.WEIGHT_IN_GM),
                Frmttr.Format(p.getPiecesPerCtn(), Frmttr.SIMPLE_NUMBER),
                Frmttr.Format(p.getSalePrice(), Frmttr.RS),
                p.getProductQty(),
                Frmttr.Format(p.getProductQty().getTotalWeightInKgs(), Frmttr.WEIGHT_IN_KG),
                Status.get(p.getStatus())
            });
        }
    }
}
