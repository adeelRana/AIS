...
public class RoutesPanel extends javax.swing.JPanel {
     ...
     * @param mainPanel
     */
    public RoutesPanel(JPanel mainPanel) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Global.addPanel(AddRoutesPanel.class, mainPanel);
    ...
    private void addDataToTable() {
        ...
        ArrayList<Route> list = (ArrayList<Route>) Global.CONTROLLER.fetch("Route").getResponseObject();
        ...
        for (Route obj : list) {
            dtm.addRow(new Object[]{
                ...
                obj.getRouteBooker(),
                obj.getWeekDay(),
                obj.getStatus() == 1 ? "Active" : "In=Active"
            });
        }
    }
}
